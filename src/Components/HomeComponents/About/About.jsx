...
const About = () => {
   return (
      <div className="py-14 mx-auto max-w-[85%] grid grid-cols-2">
         ...
         <div className='pl-8'>
            <p className='text-sm font-semibold tracking-widest text-rose-500 uppercase'>About Us</p>
            ...
            <button className="py-1.5 px-4 font-medium hover:bg-rose-500 hover:text-white transition border border-rose-500 rounded-full">Know More</button>
         </div>
      </div>
   );
};
