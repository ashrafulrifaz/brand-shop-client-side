...
const Features = () => {
   return (
      <div className="py-12 max-w-[85%] mx-auto text-center">
         <p className='text-sm font-semibold tracking-widest text-rose-500 uppercase'>Services</p>
         <h1 className="font-semibold text-4xl leading-snug">Our Diverse Services</h1>
         <p className="text-lg mt-1 mb-4">From events to tech, we have got it all</p>
         <div className="grid grid-cols-3 gap-7 text-left">
            <div className="p-5 border border-rose-300 rounded-tl-3xl rounded-br-3xl space-y-2 transition-all duration-300 hover:rounded-none hover:rounded-bl-3xl hover:rounded-tr-3xl">
               <div className='p-3 rounded-2xl bg-indigo-100 inline-block'>
                  <img src={SelectionImage} alt="selection" className='w-10' />
               </div>
               <h3 className='text-xl font-semibold'>Extensive Vehicle Inventory</h3>
            ...
            <div className="p-5 border border-rose-300 rounded-tl-3xl rounded-br-3xl space-y-2 transition-all duration-300 hover:rounded-none hover:rounded-bl-3xl hover:rounded-tr-3xl">
               <div className='p-3 rounded-2xl bg-sky-100 inline-block'>
                  <img src={FinanceImage} alt="selection" className='w-10' />
               </div>
            ...
            <div className="p-5 border border-rose-300 rounded-tl-3xl rounded-br-3xl space-y-2 transition-all duration-300 hover:rounded-none hover:rounded-bl-3xl hover:rounded-tr-3xl">
               <div className='p-3 rounded-2xl bg-rose-100 inline-block'>
                  <img src={UsersImage} alt="selection" className='w-10' />
               </div>
